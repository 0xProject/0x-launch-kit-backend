...
exports.utils = {
    ...
    validateSchema(instance, schema) {
        ...
        if (_.isEmpty(validationResult.errors)) {
            ...
            const validationErrorItems = _.map(validationResult.errors, (schemaValidationError) => schemaValidationErrorToValidationErrorItem(schemaValidationError));
...
function schemaValidationErrorToValidationErrorItem(schemaValidationError) {
    ...
    else if (_.includes(['minimum', 'maximum', 'minLength', 'maxLength', 'minItems', 'maxItems', 'enum', 'const'], schemaValidationError.name)) {
        return {
            field: schemaValidationError.property,
